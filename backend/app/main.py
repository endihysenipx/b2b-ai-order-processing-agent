...
from app.api.routes import auth, catalog_import, clients, demo_data, documents, emails, extraction, feedback, health, history, master_data, oauth, orders, reports, users
...
app.include_router(master_data.router, prefix=api_prefix, dependencies=protected)
app.include_router(history.router, prefix=api_prefix, dependencies=protected)
app.include_router(catalog_import.router, prefix=api_prefix, dependencies=protected)
